                        ...
                        <tr>
                            <td class="borderLeft keyWrapper">
                                <div class="ia_key ia_key_stock">
                                    <img src="http://bluerockre.com/css/images/ia_colors/clr_stocks.jpg" />
                                </div>
                            </td>
                            <td>
                                <i>Stocks</i>
                        ...
                        <tr class="bonds">
                            <td class="borderLeft keyWrapper">
                                <div class="ia_key ia_key_bond">
                                    <img src="http://bluerockre.com/css/images/ia_colors/clr_bonds.jpg" />
                                </div>
                            </td>
                            <td>
                                <i>Bonds</i>
                        ...
                        <tr class="">
                            <td class="borderLeft keyWrapper">
                                <div class="ia_key ia_key_hedged">
                                    <img src="http://bluerockre.com/css/images/ia_colors/clr_hedge.jpg" />
                                </div>
                            </td>
                            <td class="indented">
                        ...
                        <tr>
                            <td class="borderLeft keyWrapper">
                                <div class="ia_key ia_key_private">
                                    <img src="http://bluerockre.com/css/images/ia_colors/clr_private.jpg" />
                                </div>
                            </td>
                            <td class="indented">
        ...
        <div id="tool_results_wrapper">
            <div id="tool_results_key">
                <div class="ia_key ia_key_default">
                    <img src="http://bluerockre.com/css/images/ia_colors/grey.jpg" />
                </div>
                <span class="stocks_bonds">Traditional Portfolio</span> &nbsp; &nbsp;


                <div class="ia_key ia_key_model">
                    <img src="http://bluerockre.com/css/images/ia_colors/magenta.jpg" />
                </div>
                ...
                <div id="ia_bars" class="tool_results_right">
                    ...
                    <div class="ia_bar_wrapper">
                        ...
                        <div data-min="0" data-max="20" id="ia_bar_stddev" class="ia_bar">
                            ...
                            <div class="color-wrapper">
                                <div class="color active initial">
                                    <img src="<?php echo $bluerock; ?>/wp-content/plugins/bluerock-allocator/css/images/ia_colors/grey.jpg" />
                                    <div class="label"></div>
                                </div>
                            </div>
                            <div class="color-wrapper">
